# Generated by Django 2.1.7 on 2020-05-06 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal_type', models.CharField(default='Продаж', max_length=15)),
                ('proposal_item_type', models.CharField(default='Товари', max_length=15)),
                ('proposal_item_state', models.CharField(default='Новий', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_hash', models.CharField(default='', max_length=64)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted_time_by_requested_user', models.DateTimeField(default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal_item_state', models.CharField(default='Новий', max_length=4)),
                ...
                ('rent_time_unit_measure', models.CharField(default='Хвилина', max_length=10)),
                ('item_price_value', models.FloatField(default=1)),
                ('item_price_currency', models.CharField(default='Гривня', max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_object', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
            name='UserMessages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default='Звичайний', max_length=6)),
                ('is_blocked_by_admin', models.BooleanField(default=False)),
        ...
        migrations.AddField(
            model_name='proposals',
            name='images',
            field=models.ManyToManyField(blank=True, related_name='proposals_images', to='buy_rent_barter_app.Images'),
        ),
        migrations.AddField(
            model_name='proposals',
            name='search_tags',
        ...
        migrations.AddField(
            ...
            name='request_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buy_rent_barter_app.ProposalsItemsRequests'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='desireditemexistencenotifications',
            name='proposal_id',
        ...
        migrations.AddField(
            model_name='desireditemexistencenotifications',
            name='query_id',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='buy_rent_barter_app.DesiredItemsQueries'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buy_rent_barter_app.PossibleChainExchangeProposals'),
        ),
